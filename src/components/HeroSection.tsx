              ...
              <div className="flex gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 cursor-pointer rounded-xl border border-gold/30 flex items-center justify-center text-foreground hover:bg-gold hover:text-primary-foreground hover:border-gold transition-all duration-300"
