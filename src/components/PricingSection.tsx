...
const packages = [
  ...
  },
  {
    ...
    unit: "por m²",
    features: [
      "Pulido diamantado (nivel medio)",
      "Vitrificado estándar",
      "Sellado premium",
      "Garantía 9 meses",
    ],
    popular: false,
  ...
  {
    name: "Premium",
    description: "Restauración y acabado profesional",
    price: "Desde S/25",
    unit: "por m²",
    features: [
      "Pulido diamantado avanzado",
  ...
  {
    name: "Corporativo",
    description: "Soluciones para empresas y grandes obras",
    price: "Cotización",
    unit: "personalizada",
    features: [
      "Evaluación in situ",
      "Propuesta y proyecto a medida",
      "Precios por volumen",
      "Contratos y soporte prioritario",
    ],
    popular: false,
  },
];
  ...
  return (
    <section id="pricing" className="section-padding bg-background" ref={ref}>
      <div className="container-custom">
                ...
                {pkg.features.map((feature) => (
                  <li key={feature} className="flex items-center gap-3">
                    ...
                    >
                      <Check
                        className={`w-3 h-3 ${
                          pkg.popular ? "text-gold" : "text-muted-foreground"
                        }`}
                      />
                    </div>
        ...
        >
          * Los precios pueden variar según el estado de la superficie y las
          condiciones del espacio. Cotización exacta tras evaluación.
        </motion.p>
      </div>
    </section>
  );
