        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-cream/70 text-sm leading-relaxed max-w-md mb-6">
              Especialistas en pulido diamantado, vitrificado, sellado y
              restauración de superficies. Brindamos acabados profesionales con
              tecnología industrial en Lima, Perú.
            </p>
            <div className="flex items-center gap-2 text-sm text-cream/70">
              <MapPin className="w-4 h-4 text-gold" />
              <span>Jr. Aguarico 414, Breña - Lima</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["Inicio", "Servicios", "Trabajos", "Precios", "Contacto"].map(
                (link) => (
                  <li key={link}>
                    <a
